...
$amount = 300 * 100; // Convert 200 PHP to centavos (20000)
        ...
        "attributes" => [
            ...
            "line_items" => [
                [
                    "currency" => "PHP",
                    "amount" => $amount,
                    "name" => "Death Registration Fee",
                 "description" => "Payment for official death registration",
                    "quantity" => 1
                ]
            ],
            ...
            "success_url" => "https://civilregistrar.lgu2.com//pages/resident/deathRegistration.php",
