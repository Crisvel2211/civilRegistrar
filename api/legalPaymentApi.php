...
$amount = 500 * 100; // Convert 200 PHP to centavos (20000)
        ...
        "attributes" => [
            ...
            "line_items" => [
                [
                    "currency" => "PHP",
                    "amount" => $amount,
                    "name" => "Legal and Administrative Fee",
                 "description" => "Payment for official Legal and Administrative",
                    "quantity" => 1
                ]
            ],
            "description" => "Payment for Legal and Administrative", // ✅ Fix: Added at session level
            "payment_method_types" => ["card", "gcash", "paymaya"],
            "send_email_receipt" => true,
            "show_description" => true,
            "show_line_items" => true,
            "success_url" => "https://civilregistrar.lgu2.com/pages/resident/marriageRegistration.php",
