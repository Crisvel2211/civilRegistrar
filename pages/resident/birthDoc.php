...
$updateProfileContent = "
  <div class='container mx-auto w-full md:mt-1 px-[8px] h-[88vh] overflow-y-scroll'>
    <div class='flex items-center space-x-2 p-4'>
        ...
        <h1 class='text-2xl font-bold text-gray-800'>SUBMIT SUPPORTING DOCUMENTS (BIRTH)</h1>
    </div>

  <div class='bg-white shadow-md rounded px-8 pt-6 pb-8 mt-1 w-[88%] mx-auto'>
        ...
        <form id='documentForm' class='grid grid-cols-1 md:grid-cols-2 gap-4'>
            ...
            <div class='flex items-center justify-between col-span-2 '>
                <button type='submit' class='bg-indigo-500 hover:bg-indigo-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full'>
                    Submit
                </button>
            </div>
        </form>
